...
const NewsLatterBox = () => {
  ...
  return (
    <div className="relative z-10 rounded-sm bg-black-100 p-8 shadow-three dark:bg-gray-dark sm:p-11 lg:p-8 xl:p-11">
      <h3 className="mb-4 text-2xl font-bold leading-tight text-black dark:text-white">
        Subscribe to receive future updates
      </h3>
      <p className="mb-11 border-b border-body-color border-opacity-25 pb-11 leading-relaxed text-body-color dark:border-white dark:border-opacity-25 text-sm">
        We launch weekly newsletter about the releases and technology space
        around Data, Artificial Intelligence, and Business Analytics. This is
        your touchpoint for latest and greatest advancements in the industry
        today.
      </p>
      <div>
        <input
        ...
        <input
          ...
          className="border-stroke mb-4 w-full rounded-sm border bg-[#f8f8f8] px-6 py-3 text-base text-body-color outline-none focus:border-primary dark:border-transparent dark:bg-[#2C303B] dark:text-body-color-dark dark:shadow-two dark:focus:border-primary dark:focus:shadow-none"
        />
        <div className="mb-5 flex w-full cursor-pointer items-center justify-center rounded-sm px-9 py-1 text-base font-medium">
          <a href="#subscribe">
            <MagicButton
              title="Subscribe"
        ...
        <p className="text-center leading-relaxed text-body-color dark:text-body-color-dark text-xs">
          No spam guaranteed, add our email to the whitelist.
        </p>
      </div>
